...
class ReplySelector:
    ...
    def __init__(self, items: Dict[str, Any], user: User):
        ...
        self._user_gender: str = user.message.payload.get("client_profile", {}).get("gender", "")
        self.user_gender: str = self.get_user_gender()
        self.character_gender: str = user.message.payload.get("character", {}).get("gender", "")
        self.character_key: str = user.message.payload.get("character", {}).get("name", "")
        self.__suffix = [
